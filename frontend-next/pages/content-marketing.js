...
const gallery = [
  { src: '/img/services/content-marketing/content-writting-services-one.webp', alt: 'Content Marketing Strategy Graphic' },
  { src: '/img/services/content-marketing/content-writting-services-two.webp', alt: 'Content Distribution Graphic' },
  { src: '/img/services/content-marketing/content-writting-services-three.webp', alt: 'Texas Local Content Marketing Graphic' },
];
      ...
      <FeatureGrid
        ...
        description={
          <>
            ...
            <Link href="/social-media-marketing" className="text-primary hover:underline">
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          <div className="mt-12 grid grid-cols-1 items-center gap-8 lg:grid-cols-3">
            <Reveal className="overflow-hidden rounded-3xl lg:col-span-2">
              <img
                src="/img/services/content-marketing/before-after-content.webp"
