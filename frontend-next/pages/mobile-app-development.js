...
const gallery = [
  { src: '/img/services/mobile-app/app-gallery-1.webp', alt: 'Mobile App UI Screens' },
  { src: '/img/services/mobile-app/app-gallery-2.webp', alt: 'Travel App Booking Screens' },
  { src: '/img/services/mobile-app/app-gallery-3.webp', alt: 'Travel App Promo Screens' },
];
      ...
      <FeatureGrid
        ...
        description={
          <>
            ...
            <Link href="/web-design-development" className="text-primary hover:underline">
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          <div className="mt-12 grid grid-cols-1 items-center gap-8 lg:grid-cols-3">
            <Reveal className="overflow-hidden rounded-3xl lg:col-span-2">
              <img
                src="/img/services/mobile-app/before-after-app.webp"
