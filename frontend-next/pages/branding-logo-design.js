...
const galleryLogos = [
  { src: '/img/services/branding-logos/logo-1.webp', alt: 'Bun and Guns logo' },
  { src: '/img/services/branding-logos/logo-2.webp', alt: 'Anointed Hands Logo' },
  { src: '/img/services/branding-logos/logo-3.webp', alt: "Brooklyn's Logo" },
  { src: '/img/services/branding-logos/logo-4.webp', alt: 'Trinity Logo' },
  { src: '/img/services/branding-logos/logo-5.webp', alt: '2 Twenty Customs Logo' },
];
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          <div className="mt-12 grid grid-cols-1 items-center gap-8 lg:grid-cols-3">
            <Reveal className="overflow-hidden rounded-3xl lg:col-span-2">
              <img
                src="/img/services/before-after-branding.webp"
