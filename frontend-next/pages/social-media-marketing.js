...
const gallery = [
  { src: '/img/services/social-gallery/gallery-clients.webp', alt: 'Social Media Post Design' },
  { src: '/img/services/social-gallery/gallery-strategy.webp', alt: 'Social Media Strategy' },
  { src: '/img/services/social-gallery/gallery-ads.webp', alt: 'Ad Campaign Design' },
];
